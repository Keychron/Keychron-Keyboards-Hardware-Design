# Keychron V3 - Hardware Design Files

> 80% wired QMK custom mechanical keyboard with ABS case, hot-swappable PCB, PBT keycaps, and optional programmable knob.

**Product page:** [Keychron V3 QMK Custom Mechanical Keyboard](https://www.keychron.com/products/keychron-v3-qmk-custom-mechanical-keyboard)

![Keychron V3](https://cdn.shopify.com/s/files/1/0059/0630/1017/t/5/assets/keychronv3custommechanicalkeyboardwithqmkviacarbonblackversion-1665384169419.jpg?v=1665384171)
...
| Switch Support | Hot-swappable 3-pin and 5-pin MX mechanical switches |
| Keycaps | Double-shot OSA PBT |
| Knob | Optional, depending on version |
...
| File | Description |
|---|---|
| `V3-QMK_JIS_Plate-20260110.dwg` | JIS plate 2D CAD drawing |
| `V3-QMK_JIS_Plate-20260110.dxf` | JIS plate DXF drawing |
| `V3-QMK_JIS_Plate-20260110.pdf` | JIS plate reference drawing |
| `V3-QMK_UK_Plate-20260110.dwg` | UK plate 2D CAD drawing |
| `V3-QMK_UK_Plate-20260110.dxf` | UK plate DXF drawing |
| `V3-QMK_UK_Plate-20260110.pdf` | UK plate reference drawing |
| `V3-QMK_US_Plate-20260110.dwg` | US plate 2D CAD drawing |
| `V3-QMK_US_Plate-20260110.dxf` | US plate DXF drawing |
| `V3-QMK_US_Plate-20260110.pdf` | US plate reference drawing |
| `V3_Bottom_Case-20260110.stp` | Bottom case 3D CAD model |
| `V3_JIS_Full_Model-20260110.stp` | JIS full keyboard 3D CAD model |
| `V3_JIS_PCB-20260110.dwg` | JIS PCB 2D CAD drawing |
| `V3_Top_Case-20260110.stp` | Top case 3D CAD model |
| `V3_UK_Full_Model-20260110.stp` | UK full keyboard 3D CAD model |
| `V3_UK_PCB-20260110.dwg` | UK PCB 2D CAD drawing |
| `V3_US_Full_Model-20260110.stp` | US full keyboard 3D CAD model |
| `V3_US_PCB-20260110.dwg` | US PCB 2D CAD drawing |
