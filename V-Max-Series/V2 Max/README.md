# Keychron V2 Max — Hardware Design Files

> 65% layout, 68-key wireless gasket-mounted custom mechanical keyboard. Tri-mode connectivity (Bluetooth 5.1 / 2.4 GHz / USB-C).

**Product page:** [Keychron V2 Max](https://www.keychron.com/products/keychron-v2-max-qmk-via-wireless-custom-mechanical-keyboard)

![V2 Max](https://www.keychron.com/cdn/shop/files/V2-Max-Iconic-Features.jpg?crop=center&height=1200&v=1760175342&width=1200)
...
| Hot-swap | Yes |
| Firmware | QMK / VIA |
| Firmware Source | [Link](https://github.com/Keychron/qmk_firmware/tree/wireless_playground/keyboards/keychron/v2_max) |
...
- [Firmware Source (V2 Max)](https://github.com/Keychron/qmk_firmware/tree/wireless_playground/keyboards/keychron/v2_max)
