...
|---|---|---|
| **Plate** | Switch mounting plate with cutout dimensions (ANSI) | DWG / DXF / PDF |
...
- [Q HE Series Firmware (QMK Hall Effect branch)](https://github.com/Keychron/qmk_firmware/tree/hall_effect_playground/keyboards/keychron)
